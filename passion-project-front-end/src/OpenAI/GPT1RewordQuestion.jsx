...
const GPT1RewordQuestion = ({ apiKey, onUpdateInputValue, question, answer }) => {
           ...
           "messages": [
              {
                ...
                "content": `Reword this to make it sound authentic and technical: ${question ? question : answer}`
              }
            ],
              "max_tokens": 1000
          }, {
