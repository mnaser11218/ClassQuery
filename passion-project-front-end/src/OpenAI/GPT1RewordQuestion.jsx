...
const GPT1RewordQuestion = ({ apiKey, onUpdateInputValue, question }) => {
           ...
           "messages": [
              {
                ...
                "content": `Reword this to make it sound authentic and technical: ${question}`
              }
            ],
              "max_tokens": 1000
          }, {
  ...
  return (
    <div>
        <Button onClick={generateText}> Question Reword
...
export default GPT1RewordQuestion;