...
export const QuestionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="zipcodeoverflowApp.question.delete.question">
        <Translate contentKey="zipcodeoverflowApp.question.delete.question" interpolate={{ id: questionEntity.id }}>
