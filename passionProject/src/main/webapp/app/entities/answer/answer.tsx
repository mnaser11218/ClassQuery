          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="zipcodeoverflowApp.answer.questions">Questions</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {answerList.map((answer, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {answer.questions
                      ? answer.questions.map((val, j) => (
                          <span key={j}>
                            <Link to={`/question/${val.id}`}>{val.id}</Link>
                            {j === answer.questions.length - 1 ? '' : ', '}
                          </span>
                        ))
                      : null}
                  </td>
