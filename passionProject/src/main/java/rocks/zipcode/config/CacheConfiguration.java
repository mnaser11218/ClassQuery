...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, rocks.zipcode.domain.Question.class.getName());
            createCache(cm, rocks.zipcode.domain.Question.class.getName() + ".tags");
            createCache(cm, rocks.zipcode.domain.Question.class.getName() + ".answers");
            createCache(cm, rocks.zipcode.domain.Answer.class.getName());
            createCache(cm, rocks.zipcode.domain.Answer.class.getName() + ".questions");
            createCache(cm, rocks.zipcode.domain.Tag.class.getName());
            createCache(cm, rocks.zipcode.domain.Tag.class.getName() + ".questions");
