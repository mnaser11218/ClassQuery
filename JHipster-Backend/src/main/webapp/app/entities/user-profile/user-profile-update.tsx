  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="zipcodeoverflowApp.userProfile.home.createOrEditLabel" data-cy="UserProfileCreateUpdateHeading">
            <Translate contentKey="zipcodeoverflowApp.userProfile.home.createOrEditLabel">Create or edit a UserProfile</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('zipcodeoverflowApp.userProfile.name')}
              ...
              />
              <ValidatedField
                label={translate('zipcodeoverflowApp.userProfile.emailAddress')}
              ...
              />
              <ValidatedField
                label={translate('zipcodeoverflowApp.userProfile.aboutMe')}
              ...
              />
              <ValidatedField
                label={translate('zipcodeoverflowApp.userProfile.created')}
                id="user-profile-created"
                name="created"
                data-cy="created"
                type="date"
              />
