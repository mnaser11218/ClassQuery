...
public class UserProfileTestSamples {
    ...
    public static UserProfile getUserProfileSample1() {
        return new UserProfile().id(1L).name("name1").emailAddress("emailAddress1").aboutMe("aboutMe1");
    }

    public static UserProfile getUserProfileSample2() {
        return new UserProfile().id(2L).name("name2").emailAddress("emailAddress2").aboutMe("aboutMe2");
    }
